...
<div class="bg-gray-50 min-h-screen py-10">
    <div class="container mx-auto px-6 max-w-xl">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-xl border border-saku-primary/20">
            <h2 class="text-xl font-bold mb-4 text-saku-primary"><i class="fas fa-hand-holding-heart mr-2"></i> Donasi untuk:</h2>
            ...
            <form action="{{ route('process.donation', $program->id) }}" method="POST">
                ...
                <div class="mb-6">
                    <label for="amount" class="block text-sm font-medium text-gray-700 mb-2">Masukkan Jumlah Donasi (Min. Rp 10.000)</label>
                ...
                <div class="mt-8">
                    <button type="submit" class="w-full bg-hati-red text-white py-3 rounded-xl font-bold text-lg hover:bg-red-700 transition shadow-lg shadow-red-200">
                        Bayar Sekarang & Donasi
                    </button>
                    <p class="text-xs text-gray-500 mt-3 text-center">Anda akan diarahkan ke halaman pembayaran virtual (simulasi).</p>
                </div>
            </form>
        </div>
